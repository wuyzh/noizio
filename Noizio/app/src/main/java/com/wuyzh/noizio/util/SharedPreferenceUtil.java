...
public class SharedPreferenceUtil{
    ...
    private String sharedPreferencdName;

    public SharedPreferenceUtil(Context mContext, String sharedPreferencdName) {
        this.mContext = mContext;
        this.sharedPreferencdName = sharedPreferencdName;
    }
    /**
    ...
    public <T> T getValue(String key, Class<T> clazz) {
        ...
        SharedPreferences sp = this.mContext.getSharedPreferences(this.sharedPreferencdName, Context.MODE_PRIVATE);
